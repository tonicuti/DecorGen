...
export const HANGING_TV = "https://blendswap.com/blend_previews/5590/0/500"
...
export const SAMPLE_ASSETS: Asset[] = [
  ...
  },
  {
    ...
    defaultScale: [1, 1, 1],
    glbUrl: "http://127.0.0.1:8000/inputs/hanging_tv.glb",
    metadataCategory: "TV",
    description: "A modern flat-screen TV with a sleek design, perfect for any living space.",
    aliases: ["Hanging TV", "wall-mounted TV", "tivi treo tường"],
    tags: ["furniture", "TV", "modern", "wall-mounted"],
