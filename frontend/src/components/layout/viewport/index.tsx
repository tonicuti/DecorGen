  ...
  return (
    ...
    >
      ...
      {!!dragNodeId && (
        <div
          role="status"
          className="animate-in fade-in slide-in-from-top-4 absolute top-20 left-1/2 z-30 flex -translate-x-1/2 items-center gap-2 rounded-full border border-indigo-500/40 bg-indigo-950/95 px-4 py-2 text-xs font-medium whitespace-nowrap text-indigo-100 shadow-lg backdrop-blur-sm"
        >
